...
public class CrearPlanes extends JDialog {
	...
	private void configurarPanelDinamico() {
		...
		if (rbMovil.isSelected()) {
			...
			chkWa.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkWa.setBounds(20, 110, 100, 20);

			chkIg = new JCheckBox("Instagram");
			chkIg.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkIg.setBounds(120, 110, 100, 20);

			chkFb = new JCheckBox("Facebook"); 
			chkFb.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkFb.setBounds(220, 110, 100, 20);

			chkTk = new JCheckBox("TikTok"); 
			chkTk.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkTk.setBounds(20, 135, 100, 20);

			chkYt = new JCheckBox("YouTube");
			chkYt.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkYt.setBounds(120, 135, 100, 20);

			panelDinamico.add(chkWa); 
			panelDinamico.add(chkIg); panelDinamico.add(chkFb);
			...
			chkNetflix.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkNetflix.setBounds(20, 105, 100, 20);

			chkHBO = new JCheckBox("HBO Max"); 
			chkHBO.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkHBO.setBounds(120, 105, 100, 20);

			chkDisney = new JCheckBox("Disney+"); 
			chkDisney.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkDisney.setBounds(220, 105, 100, 20);

			chkPrime = new JCheckBox("Prime Video"); 
			chkPrime.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkPrime.setBounds(20, 130, 110, 20);

			chkAlticeTV = new JCheckBox("Altice TV"); 
			chkAlticeTV.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13)); 
			chkAlticeTV.setBounds(135, 130, 110, 20);

			panelDinamico.add(l1); 
			panelDinamico.add(spnVelocidad);
			panelDinamico.add(l2); 
			panelDinamico.add(spnMinutosHogar);
			panelDinamico.add(l3);
			panelDinamico.add(chkNetflix);
			panelDinamico.add(chkHBO); 
			panelDinamico.add(chkDisney);
			panelDinamico.add(chkPrime); 
			panelDinamico.add(chkAlticeTV);
		}
