...
public class MisEstadisticas extends JDialog {
    ...
    public MisEstadisticas() {
        ...
        setModal(true);
        // Aumentamos un poco el alto para que quepa el nuevo dato
        setSize(450, 400); 
        ...
        panelInfo.setBounds(30, 60, 375, 230); // Más alto para incluir horas
        contentPanel.add(panelInfo);
        panelInfo.setLayout(null);

        // Labels de conteo
        JLabel lbl1 = new JLabel("Instalaciones:"); lbl1.setBounds(25, 35, 150, 20); panelInfo.add(lbl1);
        lblInstalacionesVal = new JLabel("0"); lblInstalacionesVal.setBounds(250, 35, 100, 20); 
        lblInstalacionesVal.setHorizontalAlignment(SwingConstants.RIGHT); panelInfo.add(lblInstalacionesVal);

        JLabel lbl2 = new JLabel("Averías:"); lbl2.setBounds(25, 70, 150, 20); panelInfo.add(lbl2);
        lblAveriasVal = new JLabel("0"); lblAveriasVal.setBounds(250, 70, 100, 20);
        lblAveriasVal.setHorizontalAlignment(SwingConstants.RIGHT); panelInfo.add(lblAveriasVal);

        // --- NUEVO: HORAS EXTRAS ---
        JLabel lblHoras = new JLabel("Horas Extras:"); lblHoras.setBounds(25, 105, 150, 20); panelInfo.add(lblHoras);
        lblHorasExtrasVal = new JLabel("0 h"); lblHorasExtrasVal.setBounds(250, 105, 100, 20);
        lblHorasExtrasVal.setHorizontalAlignment(SwingConstants.RIGHT); panelInfo.add(lblHorasExtrasVal);
        // ---------------------------

        JLabel lbl3 = new JLabel("BONO ACUMULADO:"); lbl3.setFont(new Font("Tahoma", Font.BOLD, 13));
        lbl3.setForeground(new Color(0, 153, 51)); lbl3.setBounds(25, 165, 150, 25); panelInfo.add(lbl3);
        
        lblBonoVal = new JLabel("RD$ 0.00"); lblBonoVal.setFont(new Font("Tahoma", Font.BOLD, 15));
        lblBonoVal.setForeground(new Color(0, 153, 51)); lblBonoVal.setBounds(200, 165, 150, 25);
        lblBonoVal.setHorizontalAlignment(SwingConstants.RIGHT); panelInfo.add(lblBonoVal);
    ...
    private void calcularData() {
        ...
        try {
            ...
            // Suponiendo que tienes un método getHorasExtras() en tu clase Tecnico
            int horas = tecnicoLogueado.getHorasExtrasTrabajadas(); 
            lblHorasExtrasVal.setText(horas + " h");
            
            // Si el bono incluye también pago por horas extras, podrías sumarlo aquí
            // Por ahora solo sumamos los RD$ 250 de los tickets
