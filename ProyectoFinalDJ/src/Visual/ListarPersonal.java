...
public class ListarPersonal extends JDialog {
	...
	public ListarPersonal() {
		...
		// Campos de edición con setFont individual
		...
		txtNombre.setEditable(false); txtNombre.setBounds(20, 50, 240, 25); panelEditar.add(txtNombre);

		JLabel l2 = new JLabel("Apellido:"); 
		l2.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		l2.setBounds(20, 85, 80, 14); panelEditar.add(l2);
		
		txtApellido = new JTextField(); 
		txtApellido.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		txtApellido.setEditable(false); txtApellido.setBounds(20, 105, 240, 25); panelEditar.add(txtApellido);

		JLabel l3 = new JLabel("Salario Base:"); 
		l3.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		l3.setBounds(20, 145, 120, 14); panelEditar.add(l3);
		
		txtSalario = new JTextField(); 
		txtSalario.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		txtSalario.setBounds(20, 165, 240, 25); panelEditar.add(txtSalario);

		lblEspecial = new JLabel("Dato Especial:"); 
		lblEspecial.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		lblEspecial.setBounds(20, 205, 200, 14); panelEditar.add(lblEspecial);
		
		cmbEspecial = new JComboBox<>(); 
		cmbEspecial.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		cmbEspecial.setBounds(20, 225, 240, 25); panelEditar.add(cmbEspecial);

		lblZ = new JLabel("Zona Asignada:"); 
		lblZ.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		lblZ.setBounds(20, 265, 150, 14); panelEditar.add(lblZ);
		
		cmbZona = new JComboBox<>(new String[]{"Metropolitana", "Norte", "Sur", "Este"});
		cmbZona.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		cmbZona.setBounds(20, 285, 240, 25); panelEditar.add(cmbZona);

		chkLicencia = new JCheckBox("Licencia al día");
		chkLicencia.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
